...
function theme_mb2nl_language_list( $footer = false )
{
	...
	foreach ( $langs as $langtype => $langname )
	{
		...
		if ( $langtype !== $currentlang )
		{
			...
			$flagFile1 = $CFG->dirroot . theme_mb2nl_themedir() . '/mb2nl/pix/flags/custom/' . strtoupper($langtype) . '.png';
			$flagFile2 = $CFG->dirroot . theme_mb2nl_themedir() . '/mb2nl/pix/flags/48x32/' . strtoupper($langtype) . '.png';
